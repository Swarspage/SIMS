      ...
      >
        ...
        <div className="flex flex-col">
          ...
          >
            ...
            {(!collapsed || window.innerWidth < 768) && (
              <div className={`text-xs font-medium text-slate-500 mt-2 bg-blue-50 px-3 py-1 rounded-full ${collapsed ? "md:hidden" : "block"}`}>
            ...
            {menuItems.map((item) => {
              ...
              return (
                ...
                >
                  ...
                  {/* Show text if expanded OR if on mobile (since mobile is always expanded when open) */}
