  ...
  return (
    <header className="flex items-center justify-between px-8 py-4 bg-white border-b shadow-sm">
      ...
      <div className="flex items-center gap-5">
        ...
        <UserCircleIcon className="h-10 w-10 text-gray-600 hover:text-blue-600 cursor-pointer transition" />
        <h1>Admin</h1>
      </div>
    </header>
  );
      ...
      <div className="flex-1">
        ...
        <main className="p-6">
          <div className="mb-4 text-lg font-semibold">
            Showing total{" "}
            <span className="text-red-500">{students.length}</span> Student
          </div>
