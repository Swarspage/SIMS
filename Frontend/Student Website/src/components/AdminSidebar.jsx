...
//   return (
//     <aside className="w-64 bg-gradient-to-b from-slate-50 to-slate-100 text-slate-800 flex flex-col justify-between min-h-screen p-6 shadow-lg border-r border-slate-200">
//       {/* Top Section */}
